...
open class WebSocketClient {
    ...
    /// Return `true` if connection is active and ready to accept data.
    ...
    ///   - connectAutomatically: `true` to start connection automatically.
    ///   - options: options for connection.
    ///   - connectionQueue: queue of the connection, if not specified `main` is used.
    public init(url: URL,
    ...
    ///
    /// - Parameter interval: interval of the ping messages.
    ...
    ///
    /// - Parameter closeCode: closing code.
    ...
    private func migrateConnection(completionHandler: @escaping (Result<WebSocketClient, NWError>) -> Void) {
